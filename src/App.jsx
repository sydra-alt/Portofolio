        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Syahrafi Ahmad Pradika" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a 
                href="./assets/SCV.pdf" 
                download="Syahrafi Ahmad Pradika_CV.pdf" 
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              ...
              onContactClick={() => window.open("https://instagram.com/syahrafiap/", "_blank")}
            />
          </div>
        </div>
        {/* tentang */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m Syahrafi Ahmad Pradika, a full-stack developer passionate about building modern, high-performance applications with an intuitive user experience. I enjoy working with the latest technologies like Artificial Intelligence, Machine Learning, and cloud-based development, blending creativity with precision to deliver impactful solutions. I’m committed to helping users and businesses grow in the digital era through functional, aesthetic, and scalable digital products."
                  delay={150}
                  animateBy="words"
                  direction="top"
            ...
            src={syahrafiImg}
            alt="Syahrafi Ahmad"
            className="w-full rounded-2xl object-cover border border-violet-500/30 shadow-[0_0_30px_rgba(168,85,247,0.4)]"
            />
            </div>
          </div>
        </div>
